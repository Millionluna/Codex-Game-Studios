...
export const COMMUNICATION_NOTE_COMPOSER_NAVIGATION_COPY = {
  en: {
    ...
    discard: "Leave this page and discard the unsubmitted facts and privacy checks? They are not saved. Cancel to keep editing.",
  ...
  "zh-Hans": {
    ...
    discard: "要离开此页面并放弃未提交的事实及隐私检查吗？这些内容尚未保存。取消可继续填写。",
  ...
  "zh-Hant": {
    ...
    discard: "要離開此頁面並放棄未提交的事實及隱私檢查嗎？這些內容尚未儲存。取消可繼續填寫。",
