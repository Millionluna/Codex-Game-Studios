...
import { GuidedProfileRewriteGenerator } from "./guided-profile-rewrite-generator";

describe("guided profile rewrite generator", () => {
  it("renders an enabled rewrite control for an active-access provider draft", () => {
    const copy = getReferralWorkspaceCopy("en").materials.profileRewriteGenerator;
    const markup = renderToStaticMarkup(
      createElement(GuidedProfileRewriteGenerator, {
    ...
    expect(markup).toContain('data-testid="guided-profile-rewrite-generator"');
    expect(markup).toContain("Improve profile wording");
    expect(markup).toContain("Generate profile rewrite");
