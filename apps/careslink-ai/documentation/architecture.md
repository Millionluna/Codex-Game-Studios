...
| Communication signed terminal ACCEPTED usage alignment M1g-i | Current M1g-i retains migration 39's exact nine-key signed usage and deterministic `C` collation while projecting only the three reconciliation labels for six-fact receipt comparison. Migrations 37/38 now contain explicit repository transactions and have SHA-256 `09e69476de4b5b1b925a281f2943ef541e289aab6bef60ad92aace14d0c6d432` / `4c13bf50d7866a4b948475b598bb1c103fb625e59824be98c4e272c659da283f`; migration 39 remains `3d2cc53df3cf17ea21a4f93aaf673f8e911fcc9a35b5309cf7c633c6802e448e`. The ordered migration entries SHA-256 is `a0ad14e88a2c10400c4d2e86ee8ca4c67768ee094f8002687dd33c333c045fa2`. Transactional policy `2026-08-29.preview-transactional-migrations.6` binds manifest `60314eb32f7ac26027862e30b27e60460cf4d17d49061126f4366b08a0cbd3a2` and removes only 19 known wrappers in memory. Identity policy `2026-08-29.preview-runner-terminal-identity.2` requires strict canonical `metadata` + projected `credentials` cross-binding with exact `with_data=false`, `is_default=false`, `persistent=false`, `status=ACTIVE_HEALTHY` and source-pinned Production `parent_project_ref` before the destructive runner reads the CA or connects. Preflight/coordinator versions `preflight.communication.openai.synthetic-preview.2026-08-29.m1g-i.v5` / `coordinator.communication.openai.synthetic-preview.2026-08-29.m1g-i.v5` bind digests `0e2582040995753efe95baa071fee4e0b58fa105c79db8bfa673abd66e2d01a1` / `1f93fa2c0ba207a28cb706d922acc10bba8305f16c83c7973c70ae4d7ac7e5c2` | current focused validation passed 5 files / 79 tests plus targeted lint, Node syntax and diff checks; the complete current gate passed 172 files / 2,321 tests, TypeScript, zero-warning ESLint, 73-file adapter sync and the 64/64-page Webpack build. Fresh isolated PostgreSQL 16.15 passed 39/39; migrations 37/38 deliberately succeeded statement by statement without an ad hoc outer wrapper, A03 passed, and postcheck found zero terminal rows and zero residual SET edges. The earlier 172 files / 2,315 tests and deleted r20 Hosted run are attributable only to artifact set `4e84823`: r20 completed 39/39, A01–A18, temporary-LOGIN signed `ACCEPTED`/replay/conflict and zero-LOGIN/session cleanup, but cannot prove the current hashes/policies/v5 bindings. Exact-current Hosted/native-CLI proof awaits a separately authorized fresh disposable Preview. Live custody/credential resolution, provider evaluation, human review and final approval remain absent; readiness is false and no Production write/deployment occurred |
