...
| Communication signed terminal ACCEPTED usage alignment M1g-i | Additive migration `20260829041316_align_communication_note_preview_terminal_accepted_usage.sql` replaces only the existing signed three-argument terminal RPC: it validates and persists the exact nine-key signed usage statement, projects away only the three reconciliation labels for an exact comparison with the receipt ledger's six provider facts, and preserves signature, cost, lock, append-only, replay and ACL semantics. The rollback harness now emits fixed content-free `R00`/`A01`–`A18` stages; preflight/coordinator versions are `m1g-i.v4` with digests `a97241fafb4392b3a192be05842b619fc659b0e3026ce7f2cf37410ac2c8c22c` and `6a26e2104ebd8cecc55c638cdb2d9ec15b097630e90c0e19573addaa76fc5b2a` | source and disposable local PostgreSQL 16.15 evidence passed: 39/39 migrations, 18/18 rollback assertions and source-valid `ACCEPTED` positive/negative vectors. Migration 38 remains unchanged historical evidence; migration 39 adds no table, role, row, credential or product surface. PostgreSQL 17/Hosted, one-time Hosted LOGIN and signed `ACCEPTED` E2E remain unrun; live custody/credential resolvers and final approval remain absent. Readiness is `false`, approved values are `undefined`, and no cloud, model, real-data, deployment or Production action occurred |
