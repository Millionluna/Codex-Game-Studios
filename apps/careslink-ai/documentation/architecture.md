...
> Status: **Current-state architecture**, audited 2026-08-16; isolated database evidence updated 2026-08-23.
...
diagram. Deleted disposable `r9` closed the exact PostgreSQL 17.6 clean-apply,
rollback-assertion, role/ACL/function and cross-domain zero-fixture gate. It did
not prove the PostgreSQL 16 path or true two-connection `SKIP LOCKED` claim and
session/privacy-revocation races; those remain hard activation blockers.
Catalog/registration rows must remain
