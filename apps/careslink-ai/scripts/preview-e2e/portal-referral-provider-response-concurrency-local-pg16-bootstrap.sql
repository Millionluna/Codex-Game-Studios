-- Minimum Supabase-compatible bootstrap for the disposable Provider Response
...
--   - careslink.portal_response_concurrency_marker=2026-08-26.local-pg16.1.
...
begin
  ...
  then
    raise exception 'PORTAL_RESPONSE_CONCURRENCY_BOOTSTRAP_UNSAFE';
  end if;
  ...
  then
    raise exception 'PORTAL_RESPONSE_CONCURRENCY_BOOTSTRAP_NOT_FRESH';
  end if;
end;
$$;
